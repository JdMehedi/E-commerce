                ...
                <div class="portlet-body form">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                <input type="tel"  name="phone"  value="@if(!empty($lists->phone)) {{$lists->phone}} @endif"   placeholder="Enter phone number" class="form-control input-inline input-medium" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                <input type="text"  name="fax"   value="@if(!empty($lists->fax)) {{$lists->fax}} @endif"  placeholder="Enter fax number" class="form-control input-inline input-medium" >

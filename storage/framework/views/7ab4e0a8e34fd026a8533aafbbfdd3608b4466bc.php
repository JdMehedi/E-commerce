...
<div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <a href="#">Roles Edit-<?php echo e($role->name); ?></a>
                        </li>
            ...
            <div class="widget-body">
                <div class="collapse in">
                    <div class="create-page">
                        <form action="<?php echo e(route('roles.update',$role->id)); ?>" method="POST" enctype="multipart/form-data" data-parsley-validate data-parsley-focus="first">
                                    ...
                                    <div class="row ">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="name" name="name" value="<?php echo e($role->name); ?>" placeholder="Enter Role Name" required=""/>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" id="checkPermissionAll" value="1" <?php echo e(App\User::roleHasPermissions($role,$all_permissions) ? 'checked' : ''); ?>>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ansondistributing_barua\resources\views/roles/edit.blade.php ENDPATH**/ ?>
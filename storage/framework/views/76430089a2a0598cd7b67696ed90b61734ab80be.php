...
<?php $__env->startSection('content'); ?>
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="<?php echo e(URL::to('customs/list')); ?>">Invoice</a>
            </li>
        </ul>
    </div>
    <!-- END PAGE BAR -->
    ...
    <div class="content">
        <div class="col-md-6">
            <h3 class="page-title"> Customs List</h3>
        </div>
    </div>
    <!-- END PAGE TITLE-->
    <!-- END PAGE HEADER-->
...
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mehedi/Laravel/ansondistributing_barua_new/resources/views/customs/list.blade.php ENDPATH**/ ?>
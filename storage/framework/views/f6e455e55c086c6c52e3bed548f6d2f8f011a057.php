        ...
        <div class="row">
            <div class="col-md-12">
                <div class="portlet-body form">
                        <?php echo Form::open(array('url' => url('orders/store'),'method' => 'post', 'files' => true, 'class'=>'form-horizontal') ); ?>
                    ...
                    <div class="form-body">
                        <div class="row">
                            <div class="d-flex flex-wrap">
                                ...
                                <div class="col-md-7">
                                   ...
                                   <div class="red"><?php echo e($errors->first('shipper')); ?></div>


                                </div>
                                <div class="col-md-3">
                             <a href="<?php echo e(route('shipper.index')); ?>"><i class="fa-solid fa-circle-plus"></i></a>
                        ...
                        <div class="row m-2">
                            ...
                            <div class="red"><?php echo e($errors->first('shipper_contact_id')); ?></div>
                        ...
                        <div class="row m-2">
                                ...
                                <div class="col-md-7">
                                   ...
                                   <div class="red"><?php echo e($errors->first('consignee')); ?></div>


                                </div>
                                <div class="col-md-3">
                             <a href="<?php echo e(route('consignee.index')); ?>"><i class="fa-solid fa-circle-plus"></i></a>
                        ...
                        <div class="row m-2">
                         ...
                         <option value="">select consignee contact</option>
                            ...
                            <div class="red"><?php echo e($errors->first('consignee_contact_id')); ?></div>
                        ...
                        <div class="row m-2">
                            ...
                            <div class="red"><?php echo e($errors->first('party')); ?></div>
                        ...
                        <div class="row">
                         ...
                         <option value="">select party contact</option>
                            ...
                            <div class="red"><?php echo e($errors->first('party_contact_id')); ?></div>
                       ...
                       <div class="row">
                           <div class="d-flex">
                               ...
                               <div class="col-md-4">
                                   ...
                                   <div class="red"><?php echo e($errors->first('PO_No')); ?></div>
                               </div>
                           ...
                           <div class="col-md-4">
                               ...
                               <div class="red"><?php echo e($errors->first('POL')); ?></div>
                       ...
                       <!--  -->
                        <div class="row">
                            <div class="d-flex">
                               ...
                               <div class="red"><?php echo e($errors->first('POD')); ?></div>
                            ...
                            <div class="col-md-4">
                               ...
                               <div class="red"><?php echo e($errors->first('ramp_via')); ?></div>
                        ...
                        <div class="row">
                            <div class="d-flex">
                               ...
                               <div class="red"><?php echo e($errors->first('size')); ?></div>
                            ...
                            <div class="col-md-4">
                               ...
                               <div class="red"><?php echo e($errors->first('carrier')); ?></div>
                        ...
                        <div class="row">
                            <div class="d-flex">
                               ...
                               <div class="red"><?php echo e($errors->first('vessel_voyage')); ?></div>
                            ...
                            <div class="col-md-4">
                               ...
                               <div class="red"><?php echo e($errors->first('container')); ?></div>
                        ...
                        <div class="row">
                            <div class="d-flex">
                               ...
                               <div class="red"><?php echo e($errors->first('seal')); ?></div>
                            ...
                            <div class="col-md-4">
                               ...
                               <div class="red"><?php echo e($errors->first('cargo_weight')); ?></div>
                        ...
                        <div class="row">
                            <div class="d-flex">
                               ...
                               <div class="red"><?php echo e($errors->first('quantity')); ?></div>
                            ...
                            <div class="col-md-4">
                               ...
                               <div class="red"><?php echo e($errors->first('MBL')); ?></div>
                        ...
                        <div class="row">
                            <div class="d-flex">
                               ...
                               <div class="red"><?php echo e($errors->first('HBL')); ?></div>
                            ...
                            <div class="col-md-4">
                               ...
                               <div class="red"><?php echo e($errors->first('Commodity')); ?></div>
                        ...
                        <div class="row">
                            <div class="d-flex">
                               ...
                               <div class="red"><?php echo e($errors->first('cut_of_date')); ?></div>
                            ...
                            <div class="col-md-4">
                               ...
                               <div class="red"><?php echo e($errors->first('on_board_date')); ?></div>
                        ...
                        <div class="row">
                            <div class="d-flex">
                               ...
                               <div class="red"><?php echo e($errors->first('eta_port_date')); ?></div>
                            ...
                            <div class="col-md-4">
                               ...
                               <div class="red"><?php echo e($errors->first('eta_ramp_date')); ?></div>
                        ...
                        <div class="row">
                            <div class="d-flex">
                               ...
                               <div class="red"><?php echo e($errors->first('freight_quote')); ?></div>
                            ...
                            <div class="col-md-4">
                               ...
                               <div class="red"><?php echo e($errors->first('exw_local')); ?></div>
                        ...
                        <div class="row">
                            <div class="d-flex">
                               ...
                               <div class="red"><?php echo e($errors->first('wharfage')); ?></div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                               ...
                               <div class="red"><?php echo e($errors->first('delivery_address')); ?></div>
                        ...
                        <div class="row text-center">
                            <div class="col-md-12">
                                <button type="submit" class="btn green">
                                    <?php echo e(isset($shipper) ? 'Submit' : 'Update'); ?>
    ...
    <script>
        ...
        $('#shipper').on('change', function (event){
           var shipper = $('#shipper').val();
                    ...
                    $.ajax({
                        type: 'get',                    
                        url: "<?php echo e(\Illuminate\Support\Facades\URL::to('shipper_info_order_form')); ?>",
                        dataType: 'json',
        ...
        $('#shipper_contact_id').on('change', function (event){
           var shipper_contact_id = $('#shipper_contact_id').val();
                    ...
                    $.ajax({
                        type: 'get',                    
                        url: "<?php echo e(\Illuminate\Support\Facades\URL::to('shipper_contact_info_order_form')); ?>",
                        dataType: 'json',
        ...
        $('#consignee').on('change', function (event){
           var consignee = $('#consignee').val();
                    $.ajax({
                        type: 'get',                    
                        url: "<?php echo e(\Illuminate\Support\Facades\URL::to('consignee_info_order_form')); ?>",
                        dataType: 'json',
        ...
        $('#consignee_contact_id').on('change', function (event){
           var consignee_contact_id = $('#consignee_contact_id').val();
                    $.ajax({
                        type: 'get',                    
                        url: "<?php echo e(\Illuminate\Support\Facades\URL::to('consignee_contact_info_order_form')); ?>",
                        dataType: 'json',
        ...
        $('#party').on('change', function (event){
           var party = $('#party').val();
                    $.ajax({
                        type: 'get',                    
                        url: "<?php echo e(\Illuminate\Support\Facades\URL::to('party_info_order_form')); ?>",
                        dataType: 'json',
                        data: {party:party},
        ...
        $('#party_contact_id').on('change', function (event){
           var party_contact_id = $('#party_contact_id').val();
                    $.ajax({
                        type: 'get',                    
                        url: "<?php echo e(\Illuminate\Support\Facades\URL::to('party_contact_info_order_form')); ?>",
                        dataType: 'json',
        ...
        var SAconsignee =$("input[name='sameAsConsignee']:checked").val();
           ...
           console.log(consignee_contact_id);
                $.ajax({
                        type: 'get',                    
                        url: "<?php echo e(\Illuminate\Support\Facades\URL::to('sameAsConsignee')); ?>",
                        dataType: 'json',
...
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mehedi/Laravel/ansondistributing_barua_new/resources/views/admin/orders/create.blade.php ENDPATH**/ ?>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="portlet-body form">
                    ...
                    <?php echo Form::open(array('url' => url('passwordSave'), 'files' => true, 'class'=>'form-horizontal') ); ?>
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                ...
                                <div class="red"><?php echo e($errors->first('current_password')); ?></div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                ...
                                <div class="red"><?php echo e($errors->first('new_password')); ?></div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                ...
                                <div class="red"><?php echo e($errors->first('new_confirm_password')); ?></div>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ansondistributing_barua\resources\views/profiles/passwordChange.blade.php ENDPATH**/ ?>
            ...
            <div style="background-color: #3e6562;" class="page-header-inner ">
                ...
                <div style="background-color: #3e6562;" class="page-logo">
                    <a href="<?php echo e(URL::to('adminUser')); ?>">
                        <img src="<?php echo e(URL::to('/')); ?>/sharing/images/srh2.png" alt="logo" class="logo-default" width="80"/> </a>
                ...
                <div style="background-color: #3e6562;" class="page-sidebar navbar-collapse collapse" >
                    ...
                    <ul style="background-color: #3e6562;" class="page-sidebar-menu  page-header-fixed "  data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                        ...
                        <li class="nav-item <?php echo e(in_array(Request::path(), $members) ? 'active' : ''); ?>">
                            ...
                            <ul  class="sub-menu">
                                <li  class="nav-item <?php echo e(Request::path() == 'notices/add' ? 'active' : ''); ?>">
                                    <a   href="<?php echo e(URL::to('notices/add')); ?>" class="nav-link ">
                                        <span  class="title">Add Notice</span>
                                    </a>
                                </li>
                                <li class="nav-item <?php echo e(Request::path() == 'notices' ? 'active' : ''); ?>">
                                    <a  href="<?php echo e(URL::to('notices')); ?>" class="nav-link ">
...
</html><?php /**PATH C:\xampp\htdocs\Barua Scale Project\ansondistributing_barua\resources\views/layouts/user.blade.php ENDPATH**/ ?>
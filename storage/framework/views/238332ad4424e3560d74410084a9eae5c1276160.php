...
<?php $__env->startSection('content'); ?>
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="<?php echo e(URL::to('invoice/list')); ?>">Invoice</a>
            </li>
        </ul>
    </div>
    <!-- END PAGE BAR -->
...
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mehedi/Laravel/ansondistributing_barua_new/resources/views/invoice/invoiceList.blade.php ENDPATH**/ ?>